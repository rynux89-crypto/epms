...
<div class="title-bar">
    ...
    <div style="display:flex; gap:8px; align-items:center;">
        <button class="back-btn" onclick="location.href='/epms/energy/energy_overview.jsp'">에너지 현황</button>
        <button class="back-btn" onclick="location.href='/epms/energy/carbon_emissions.jsp'">탄소배출량</button>
        <button class="back-btn" onclick="location.href='/epms/energy/energy_sankey.jsp' + location.search">에너지 흐름 분석</button>
...
function goSankeyDrill(label) {
  ...
  window.location.href = "/epms/energy/energy_sankey.jsp?" + qs.toString();
}

...
<div class="page-wrap">
    <div class="title-bar">
        ...
        <div class="inline-actions">
            <button class="back-btn" onclick="location.href='/epms/plc/ai_mapping.jsp'">AI 매핑</button>
            <button class="back-btn" onclick="location.href='/epms/plc/ai_measurements_mapping_manage.jsp'">매핑 정의 관리</button>

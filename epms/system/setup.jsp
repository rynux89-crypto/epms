...
private void saveToml(File file, Map<String, String> cfg) throws Exception {
    ...
    sb.append("[agent]\n");
    sb.append("properties_path = ").append(q(nv(cfg.get("agent.properties_path"), "epms/agent/agent_model.properties"))).append('\n');
...
String agentPropertiesPath = nv(cfg.get("agent.properties_path"), "epms/agent/agent_model.properties");
